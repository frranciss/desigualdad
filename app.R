...
rsconnect::setAccountInfo(name='desigualdad-contarcondatos', 
                          token='BBECAA9BFECE626BF60F393FC2549F7F', 
                          secret='1tH+THg/GaehgvJMuYKx6hep5GGEdoYZaMQrwhvZ')
rsconnect::deployApp("C:/Users/adria/OneDrive/Documentos/udesa")
